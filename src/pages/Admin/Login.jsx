...
const AdminLogin = () => {
  ...
  const handleForgotEmailSubmit = (e) => {
    ...
    setError("");
    if (
      resetEmail !== adminProfile.email &&
      resetEmail !== "admin@wrapngift.com"
    ) {
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-4 border border-gray-200 text-gray-600 rounded-xl font-bold uppercase tracking-widest text-[10px] hover:bg-gray-50"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-[2] py-4 bg-primary text-white rounded-xl font-bold uppercase tracking-widest text-[10px] shadow-lg shadow-primary/30 hover:bg-opacity-90"
                >
                  Send Reset Code
                </button>
              </div>
