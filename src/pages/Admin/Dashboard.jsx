...
const FieldLabel = ({ children }) => (
  <label className="block text-[10px] uppercase tracking-[0.2em] text-gray-400 font-bold mb-1">
    {children}
  </label>
);
...
const SectionCard = ({
  ...
  return (
    <div
      className={`bg-white rounded-2xl shadow-sm border border-gray-100 border-t-4 ${accent} overflow-hidden`}
    >
      <button
        onClick={() => setOpen((o) => !o)}
...
const ServicesEditor = ({ content, updateContent, saveStatus }) => {
  const cards = Array.isArray(content.services_cards)
...
const ValuesEditor = ({
  ...
  const addValue = () => {
    updateContent(contentKey, [
      ...values,
      { icon: "Heart", title: "New Value", desc: "" },
    ]);
  };
...
const StatsEditor = ({ content, updateContent, saveStatus }) => {
  ...
  const addStat = () =>
    updateContent("stats", [...stats, { number: "0", label: "New Stat" }]);
  const removeStat = (i) =>
    updateContent(
      "stats",
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex justify-end">
        <SaveIndicator status={saveStatus["stats"]} />
      </div>
    </div>
  );
};
    ...
    <div className="space-y-6">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ContentField
            label="Section Title"
            contentKey="about_home_title"
            {...fieldProps}
          />
          <ContentField
            label="Highlighted Phrase in Title"
            contentKey="about_home_title_highlight"
            {...fieldProps}
          />
        </div>
        <ContentField
          label="Paragraph 1"
          contentKey="about_home_para1"
          type="textarea"
          rows={3}
          {...fieldProps}
        />
        ...
        <div className="grid grid-cols-2 gap-4">
          <ContentField
            label="Stat 1 – Number"
            contentKey="about_home_stat1_number"
            {...fieldProps}
          />
          <ContentField
            label="Stat 1 – Label"
            contentKey="about_home_stat1_label"
            {...fieldProps}
          />
          <ContentField
            label="Stat 2 – Number"
            contentKey="about_home_stat2_number"
            {...fieldProps}
          />
          <ContentField
            label="Stat 2 – Label"
            contentKey="about_home_stat2_label"
            {...fieldProps}
          />
        </div>
        <ContentImageField
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ContentField
            label="Page Hero Badge"
            contentKey="aboutpage_hero_badge"
            {...fieldProps}
          />
          <ContentField
            label="Page Hero Title"
            contentKey="aboutpage_hero_title"
            {...fieldProps}
          />
        </div>
        <ContentImageField
          label="Hero Background Image"
          contentKey="aboutpage_hero_image"
          {...fieldProps}
        />
        ...
        <div className="border-t border-gray-100 pt-5">
          ...
          <div className="space-y-4">
            <ContentField
              label="Vision Title"
              contentKey="aboutpage_vision_title"
              {...fieldProps}
            />
            <ContentField
              label="Quote / Italic Text"
              contentKey="aboutpage_vision_quote"
              type="textarea"
              rows={3}
              {...fieldProps}
            />
            <ContentField
              ...
              contentKey="aboutpage_vision_para"
              type="textarea"
              rows={3}
              {...fieldProps}
            />
        ...
        <div className="border-t border-gray-100 pt-5">
          ...
          <ContentField
            label="Section Title"
            contentKey="aboutpage_promise_title"
            {...fieldProps}
          />
          <div className="mt-4">
...
const AdminDashboard = () => {
  ...
  const handleDeleteCategory = async () => {
    ...
    const remainingIds = Object.keys(categories).filter(
  ...
  const saveProductChanges = () => {
    ...
    if (
      ...
      editedProduct.category_id !== selectedCategory
    ) {
      updateProduct(
        selectedCategory,
        editingProductId,
  ...
  if (loading) {
    return (
      <div className="h-screen flex items-center justify-center text-primary font-serif text-xl">
        Loading Admin Panel...
      </div>
    );
  }
  ...
  const handleOtpSubmit = async (e) => {
    ...
    if (!res.success) {
      setPasswordMessage({
        text: "Failed to update password. " + (res.error || ""),
        type: "error",
      });
      return;
    }
      ...
      <div className="flex items-start gap-4 mb-8 border-b pb-6">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1 uppercase tracking-widest">
            Manage your entire website from here
          </p>
        </div>
      </div>
          ...
          <div className="space-y-2">
            {TABS.map((tab) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-xl font-bold uppercase tracking-widest text-xs transition-all ${
                  activeTab === tab.id
            ...
            <div className="animate-in fade-in duration-500">
              <div className="mb-6 p-4 bg-primary/5 border border-primary/20 rounded-xl">
                <p className="text-xs text-primary font-bold uppercase tracking-widest">
                  🎨 Site Content Editor — Changes save automatically to
                  Supabase and are reflected live on the website
                </p>
              </div>
              <SiteContentTab />
            </div>
                ...
                <div className="bg-white p-8 shadow-md border-t-4 border-green-500 animate-in fade-in slide-in-from-top-4 duration-500 rounded-2xl">
                  ...
                  <div className="space-y-6">
                    ...
                    <ImageUpload
                      ...
                      onImageUploaded={(url) =>
                        setNewCategory({ ...newCategory, banner: url })
                      }
                    ...
                    <div className="flex justify-end pt-4 gap-4">
                      <button
                        onClick={() => setIsAddingCategory(false)}
                        className="px-8 py-3 rounded-lg text-gray-500 font-bold uppercase tracking-widest text-xs hover:bg-gray-100"
                      >
                        Cancel
                      </button>
                      <button
                        onClick={handleAddCategory}
                        className="bg-primary text-white px-10 py-3 rounded-lg hover:bg-opacity-90 transition-all font-bold uppercase tracking-widest text-xs shadow-lg shadow-primary/20"
                      >
                        Create Collection
                      </button>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border p-2 rounded-lg focus:border-primary outline-none"
                      />
                    </div>
                    <div>
                      <FieldLabel>Subtitle</FieldLabel>
                    ...
                    <ImageUpload
                      ...
                      onImageUploaded={(url) =>
                        updateCategory(selectedCategory, "banner", url)
                      }
                      label="Banner Image"
                    />
                  </div>
                ...
                <div className="bg-white p-8 shadow-md rounded-2xl">
                  ...
                  <div className="space-y-3 mb-8">
                    {currentCategory.products.map((product) => (
                      <div
                        key={product.id}
                        className="border border-gray-100 p-4 rounded-xl hover:shadow-md transition-all"
                      >
                          ...
                          <div className="space-y-3">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              <input
                                ...
                                className="border p-2 rounded-lg outline-none focus:border-primary"
                            ...
                            <div>
                              ...
                              <select
                                ...
                                className="w-full border p-2 rounded-lg outline-none focus:border-primary text-sm"
                              >
                                {Object.values(categories).map((cat) => (
                            ...
                            <div className="flex gap-2 justify-end">
                              <button
                                ...
                                className="flex items-center gap-2 bg-green-500 text-white px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest"
                              >
                                <Save size={14} /> Save
                              </button>
                              <button
                                onClick={cancelEditingProduct}
                                className="flex items-center gap-2 bg-gray-400 text-white px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-widest"
                              >
                                <X size={14} /> Cancel
                              </button>
                            </div>
                  ...
                  <div className="bg-pearl p-6 rounded-2xl border-2 border-dashed border-gray-200">
                    ...
                    <div className="flex justify-end pt-4">
                      <button
                        ...
                        className="bg-primary text-white px-10 py-3 rounded-full hover:bg-opacity-90 transition-all font-bold uppercase tracking-widest text-[10px] shadow-lg shadow-primary/20"
                      >
                        Add Product
                      </button>
                    </div>
            ...
            <div className="space-y-8 animate-in fade-in duration-500">
              <div className="bg-white p-8 shadow-md border-t-4 border-highlight rounded-2xl">
                <div className="flex justify-between items-center mb-8">
                  ...
                  >
                    {isAddingTestimonial ? <X size={14} /> : <Plus size={14} />}{" "}
                    {isAddingTestimonial ? "Cancel" : "Add New"}
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  {testimonials.map((t) => (
                    <div
                      key={t.id}
                      className="border border-gray-100 p-6 rounded-2xl hover:shadow-lg transition-all bg-white relative group"
                    >
                      <div className="flex gap-6 items-start">
                        <img
                          src={t.image_url || "https://via.placeholder.com/80"}
                ...
                <div className="max-w-xl">
                  <form onSubmit={handleProfileSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-500 mt-1 uppercase tracking-widest">
                        Used for receiving important alerts
                      </p>
                    </div>
                    <div className="pt-4 border-t border-gray-100 flex items-center gap-4">
                      ...
                      {profileSaveStatus && (
                        <span className="text-green-500 font-bold uppercase tracking-widest text-[10px] flex items-center gap-1">
                  ...
                  {otpStep ? (
                    <form
                      ...
                      className="mt-10 space-y-6 pt-10 border-t border-gray-100"
                    >
                      ...
                      {passwordMessage.text && (
                        <div
                          className={`p-3 rounded-lg text-xs font-bold uppercase tracking-widest flex items-center gap-2 ${passwordMessage.type === "error" ? "bg-red-50 text-red-600" : "bg-green-50 text-green-600"}`}
                        >
                  ...
                  <div className="mt-12 bg-gray-50 p-6 rounded-xl border border-gray-100">
                    ...
                    <div className="space-y-2 text-sm text-gray-600">
                      ...
                      <p className="flex justify-between border-b pb-2">
                        ...
                        <span>v2.1.0 (Promotional Gifts Enabled)</span>
                      </p>
