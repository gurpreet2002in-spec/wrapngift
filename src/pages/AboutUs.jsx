...
const AboutUs = () => {
  ...
  const values = Array.isArray(content.aboutpage_values)
    ? content.aboutpage_values
    : [];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <HtmlContent
                html={content.aboutpage_vision_quote}
                className="text-gray-600 leading-relaxed text-lg italic"
              />
              <HtmlContent
                html={content.aboutpage_vision_para}
      ...
      <section className="py-24 bg-secondary text-white relative overflow-hidden">
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat, i) => (
              <div key={i}>
                <p className="text-5xl font-serif text-accent mb-2">
                  {stat.number}
                </p>
      ...
      <section className="py-24 bg-white text-center">
        <div className="container mx-auto px-6 max-w-2xl">
          <h2 className="font-serif text-4xl text-primary mb-8 leading-tight">
            Ready to make your next occasion unforgettable?
          </h2>
          <Link
            to="/#contact"
