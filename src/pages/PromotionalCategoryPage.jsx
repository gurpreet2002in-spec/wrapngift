    ...
    return (
      <div className="h-screen flex flex-col items-center justify-center">
        <h2 className="text-2xl text-primary mb-4">
          Promotional Category not found
        </h2>
    ...
    <div className="min-h-screen bg-white pt-20">
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          {category.products.length === 0 && (
            <p className="col-span-full text-center text-gray-500 py-10">
              No promotional products added to this category yet.
            </p>
          )}
        </div>
        ...
        <div className="mt-16 text-center border-t border-gray-200 pt-8">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-primary uppercase tracking-[0.15em] text-xs font-bold hover:text-accent transition-colors"
          >
