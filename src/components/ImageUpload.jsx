  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Upload Button */}
        <label
          className={`flex items-center gap-2 px-4 py-2 border-2 border-dashed rounded cursor-pointer transition-all ${
            uploading
              ? "bg-gray-100 border-gray-300"
              : "hover:bg-gray-50 border-gray-400 hover:border-primary"
          }`}
        >
          {uploading ? (
            <>
