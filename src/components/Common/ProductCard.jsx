...
const ProductCard = ({ product, categoryId }) => {
  ...
  return (
    <div className="group cursor-pointer bg-royalty border border-white/5 shadow-2xl hover:shadow-[0_40px_80px_-20px_rgba(25,55,60,0.4)] transition-all duration-700 flex flex-col h-full rounded-[2rem] overflow-hidden relative">
