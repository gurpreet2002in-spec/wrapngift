      ...
      <div className="container mx-auto px-6">
        {features.map((feature, index) => (
          ...
          >
            ...
            <div
              className={`absolute top-0 ${index % 2 === 0 ? "right-10 text-white/5" : "left-10 text-secondary/5"} font-serif text-[200px] leading-none pointer-events-none italic`}
            >
              0{feature.id}
            </div>
            ...
            >
              <div className="relative p-4">
                ...
                <div
                  className={`absolute top-0 ${index % 2 === 0 ? "left-0" : "right-0"} w-12 h-12 border-t-2 border-l-2 border-accent`}
                ></div>
              </div>
            </motion.div>
