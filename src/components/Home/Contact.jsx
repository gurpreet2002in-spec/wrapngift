...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Oops! Something went wrong. Please try again or contact us directly via WhatsApp/Phone.",
      );
    } finally {
  ...
  return (
    <section
      id="contact"
      className="py-32 bg-secondary text-white relative overflow-hidden mesh-gradient-midnight"
    >
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-7xl">
        <div className="flex flex-col lg:flex-row gap-20 items-center lg:items-start">
          ...
          <div className="lg:w-1/3">
            <span className="text-accent uppercase tracking-[0.4em] text-xs font-bold mb-6 block drop-shadow-md">
              Get in Touch
            </span>
            <h2 className="font-serif text-5xl md:text-7xl mb-12 leading-tight text-white text-glow">
            ...
            <div className="space-y-12">
              <div className="flex gap-6 group">
                ...
                <div>
                  <h4 className="text-white/50 font-bold text-[10px] uppercase tracking-[0.3em] mb-2">
                    Call Us
                  </h4>
                ...
                <div className="text-center space-y-6 animate-in fade-in zoom-in duration-500">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">
                      Your inquiry has been sent successfully. We will get back
                      to you shortly.
                    </p>
                  </div>
                  <button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        >
                          <option className="bg-secondary" value="Corporate">
                            Corporate Gifting
                          </option>
                          <option className="bg-secondary" value="Wedding">
                            Wedding Hampers
                          </option>
                          <option className="bg-secondary" value="Festive">
                            Festive Celebrations
                          </option>
                          <option className="bg-secondary" value="Bespoke">
