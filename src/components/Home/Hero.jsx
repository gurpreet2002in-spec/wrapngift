...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex items-center bg-secondary overflow-hidden mesh-gradient-midnight">
      {/* Background Image */}
      ...
      <div className="relative z-20 container mx-auto px-6">
        <div className="max-w-4xl">
          ...
          <HtmlContent
            html={content.hero_subtitle}
            className="text-pearl/80 text-lg md:text-xl mb-12 leading-relaxed max-w-2xl font-light"
          />
