      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <HtmlContent
              html={content.about_home_para1}
              className="text-gray-600 mb-6 leading-relaxed"
            />
            <HtmlContent
              html={content.about_home_para2}
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                <h4 className="font-serif text-xl text-primary mb-2">
                  {content.about_home_stat1_number}
                </h4>
                <p className="text-sm text-gray-500">
                  {content.about_home_stat1_label}
                </p>
              </div>
              <div>
                <h4 className="font-serif text-xl text-primary mb-2">
                  {content.about_home_stat2_number}
                </h4>
                <p className="text-sm text-gray-500">
                  {content.about_home_stat2_label}
                </p>
              </div>
            </div>
