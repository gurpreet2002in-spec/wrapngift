          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <HtmlContent
                ...
                className="text-xl md:text-2xl font-serif text-royalty/90 leading-relaxed italic mb-10 max-w-2xl before:content-['\201C'] after:content-['\201D']"
              />

              <div className="space-y-1">
                <h4 className="text-lg font-bold text-royalty tracking-widest uppercase">
                  {current.name}
                </h4>
                <p className="text-xs text-highlight font-bold tracking-[0.2em] uppercase">
                  {current.role || "Happy Client"}
                </p>
              </div>
            </motion.div>
          </AnimatePresence>
