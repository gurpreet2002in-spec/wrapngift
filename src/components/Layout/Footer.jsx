        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="text-white/60 text-[13px] leading-relaxed max-w-[260px]">
              Your trusted partner in creating unforgettable gifting
              experiences. Bespoke hampers curated with love and elegance.
            </p>
          </div>

          {/* 2. Quick Links */}
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:pl-8">
            <h4 className="text-accent font-serif text-lg font-bold mb-8 tracking-wide">
              Quick Links
            </h4>
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="space-y-5 mb-8">
              <a
                href={`tel:+91${content.contact_whatsapp}`}
            ...
            <div className="flex space-x-4">
              {content.social_facebook && (
                <a
                  ...
                  className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-white hover:bg-accent hover:border-accent hover:text-secondary transition-all"
                >
                  <Facebook size={20} />
                </a>
              )}
